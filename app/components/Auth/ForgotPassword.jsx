...
const ForgotPasswordComponent = ({ onUpdate, isShowOtherInfo = true }) => {
    ...
    const renderPhoneInput = () => (
        <form className="auth-card-form" onSubmit={handlePhoneSubmit}>
            ...
            <button type="submit" className="auth-card-form-btn primary__btn bg-success" disabled={loading.phone}>
    ...
    const renderFormInputs = () => (
        <form className="auth-card-form" onSubmit={handleFinalSubmit}>
            ...
            <button type="submit" className="auth-card-form-btn primary__btn bg-info" disabled={loading.register}>
                {loading.register ? <Spinner /> : 'Reset Password'}
            </button>
        </form>
    );
        ...
        <div className="auth-card">
            <div className="auth-card-head">
                <Image
                    ...
                    loading="lazy"
                />
                <h4 className="auth-card-title mt-3">Reset Password</h4>
            </div>
